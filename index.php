...
<html lang="en-US">
<head>
<title>FletChatAI - The AI companion</title>
<link rel="icon" >
<meta charset="utf-8">
<meta name="keywords" content="flet, open-source">
...
<div class="page-con-content landing-con-override">
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx2-heading'>
							<p>
								 Flet Chat AI is a AI program built on flet, the python framework which use Flutter wigets to render interface.
							</p>
								...
								<div class="build-btn-button">
									<div class="build-ico-button">
										<div class="build-ico-os">
											...
											<img alt="GitHub" src="img/icons/list/github-mark.png" style='height: 100%; width: 100%; object-fit: contain; display:none;'/>
										</div>
									</div>
									<a href="https://github.com/axeinstd/Flet-Chat-AI/releases">
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(/img/graphics/landing/heroZ.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="handheld-con-container">
					<div class="handheld-con-screen">
						<div class="handheld-img-screen">
							<img alt="1" src="img/graphics/landing/handheld-1.png" style='height: 100%; width: 100%; object-fit: contain'/>
							<img alt="2" src="img/graphics/landing/handheld-2.png" style='height: 100%; width: 100%; object-fit: contain; display:none;'/>
						</div>
					</div>
					<div class="handheld-txt-container">
						<div class="handheld-tx1-title darkmode-txt">
							<span>Flet Chat AI contains models for all occasions</span>
						</div>
						<div class="handheld-tx2-desc darkmode-txt">
							<span>Flet Chat AI 1.0 is pictured above. Please note that other versions may differ from the picture.</span>
						</div>
						<a href="https://github.com/axeinstd/Flet-Chat-AI">
						<div class="handheld-btn-button">
							<div class="handheld-ico-button" img>
							</div>
							<div class="handheld-tx1-button">
								<span>Get started with llama3-70b*</span>
							</div>
						</div>
						</a>
					</div>
				...
				<div class="discord-con-container">
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<a href="https://discord.gg/9Hk63YHa3N" target="_blank">
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							...
							<div class="github-tx2-mantra darkmode-txt">
								<p>
									My project is very simple now, so if you want improve it you can improve it! Source code is always in the releases: source-code.zip. But, pleas, dont forget to comply with the Apache License 2.0. :)
								</p>
							</div>
							<a href="https://github.com/axeinstd/Flet-Chat-AI" target="_blank">
	...
	<div class="landing-con-patreon darkmode-patreon">
		<div class="patreon-img-backdrop-2">
		</div>
		<div class="patreon-img-overlay">
		</div>
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class="patreon-con-container">
					...
					<div class="patreon-con-mantra">
						<div class="patreon-wrp-mantra scale-content-txt-1 ">
							<div class="patreon-tx1-mantra">
								<h2>We are on DonationAlerts.</h2>
								<div class="landing-con-divider" style="background: #ff424d">
								</div>
							</div>
							<div class="patreon-tx2-mantra darkmode-txt">
								<p>
									Today everyone wants to get some money for his work :)
								</p>
							</div>
							<a href="https://www.donationalerts.com/r/axeinstd" target="_blank">
							<div class="patreon-btn-button">
								<div class="patreon-ico-button">
								</div>
								<div class="patreon-tx1-button">
